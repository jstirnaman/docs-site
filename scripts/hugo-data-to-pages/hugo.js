...
let config = {
  ...
  dataFolder: process.env.DATA_FOLDER, //Data folder path (will fetch ALL files from here)
  ...
  contentPath: process.env.CONTENT_PATH, //Path to content directory (in case it's not "content")
